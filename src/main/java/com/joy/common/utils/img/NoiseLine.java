package com.joy.common.utils.img;
...
public class NoiseLine {
	...
	public NoiseLine() {
		...
		int y = 0;
		try {
			final BufferedImage img = ImageIO.read(new File("/Users/shenghui555/Downloads/a_1.jpeg"));
			this.renderImg = img;
...
//				System.out.print(this.b[i] + " ");
	...
	public void saveImg() {
		try {
			ImageIO.write(this.renderImg, "JPG", new File("/Users/shenghui555/Downloads/a_2.jpg"));
		} catch (final IOException e) {
			e.printStackTrace();
		}
	}
